...
async function main() {
  ...
  const forceStudentRole = whitelist.forceStudentRole !== false;
  ...
  for (const uid of uids) {
    ...
    const payload = {
      ...
      allAccessGrantedBy: 'whitelist_script',
    ...
    if (forceStudentRole) {
      ...
      payload.accountTypeChangeUsed = true;
    }
  ...
  await batch.commit();
  console.log(`Granted all_access to ${uids.size} users.`);
}
